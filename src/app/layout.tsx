      ...
      <body id="top">
        ...
        <header className="site-header">
          <div className="header-top-bar">
            📞 24/7 Booking: +91 92047 14249 &nbsp;|&nbsp; ✉️ info@sreetravel.com &nbsp;|&nbsp; 🏆 Jharkhand&apos;s Most Trusted Cab Service
          </div>
          <div className="header-main">
            <a href="/" className="logo-area" style={{ textDecoration: 'none' }}>
              ...
              <div className="logo-text">
                <div style={{ fontSize: '1.15rem', fontWeight: 800, color: '#f8fafc' }}>Sree Travels</div>
                <p>Jharkhand&apos;s #1 Cab Service</p>
              </div>
            </a>
            <nav style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
              <a href="/about" style={{ color: 'var(--text-secondary)', textDecoration: 'none', fontSize: '0.85rem', fontWeight: 600, transition: 'color 0.2s ease' }}>About</a>
              <a href="/contact" style={{ color: 'var(--text-secondary)', textDecoration: 'none', fontSize: '0.85rem', fontWeight: 600, transition: 'color 0.2s ease' }}>Contact</a>
              <div className="header-actions">
                <a href="tel:+919204714249" className="header-phone">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg> +91 92047 14249
                </a>
                <a
        ...
        <div className="mobile-cta">
          <a href="tel:+919204714249" className="call-btn">
